    ...
    <section id="gpsr" className="mx-auto mt-8 max-w-6xl rounded-3xl border border-white/10 bg-neutral-950 p-6 md:p-10">
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        <div>
          ...
          <p className="mt-1 text-neutral-300">Maszyny i łuparki przekładniowe rozwijane oraz kompletowane w Polsce.</p>
        </div>
        <div>
      ...
      <div className="mt-7 border-t border-white/10 pt-6">
        ...
        <p className="mt-2 whitespace-pre-line text-neutral-300">
          Produkt przeznaczony do mechanicznego łupania drewna opałowego. Przed użyciem należy przeczytać instrukcję, sprawdzić osłony i stosować wymagane środki ochrony indywidualnej. Nie wolno modyfikować konstrukcji ani omijać zabezpieczeń.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <main className="min-h-screen bg-black px-6 py-12 text-white">
      ...
      <article className="mx-auto grid max-w-6xl gap-10 overflow-hidden rounded-3xl border border-white/10 bg-neutral-950 p-6 shadow-2xl md:grid-cols-2 md:p-10">
        ...
        <div>
          <a href="/#oferty" className="text-sm font-semibold text-neutral-400 hover:text-white">
            ← Wróć do ofert
          </a>

          <p className="mt-8 text-sm font-bold uppercase tracking-[0.2em] text-red-500">
            PolMech • aktualna oferta
          </p>
          ...
          <p className="mt-3 text-neutral-300">
            {product.stock > 0 ? `Dostępne: ${product.stock} szt.` : "Sprawdź aktualną dostępność"}
          </p>
          ...
          <div className="mt-8 grid gap-3">
            <a
              ...
              className="rounded-2xl bg-red-600 px-6 py-4 text-center text-lg font-black transition hover:bg-red-500"
            >
            ...
            <a
              ...
              className="rounded-2xl border border-white/20 px-6 py-4 text-center font-bold transition hover:bg-white/10"
            >
              Kup na Allegro
            </a>
          </div>
          ...
          <p className="mt-6 text-sm text-neutral-500">
            Darmowa dostawa na terenie Polski. Cena i dostępność są aktualizowane automatycznie.
          </p>
        </div>
      </article>
      ...
      <section className="mx-auto mt-8 max-w-6xl rounded-3xl border border-white/10 bg-neutral-950 p-6 md:p-10">
        ...
        <p className="mt-4 max-w-4xl leading-relaxed text-neutral-300">
          Produkt można kupić przez Allegro albo zamówić bezpośrednio za pobraniem. Dla zamówień za pobraniem oferujemy darmową dostawę na terenie Polski po wcześniejszym potwierdzeniu dostępności i warunków wysyłki.
        </p>
      </section>
